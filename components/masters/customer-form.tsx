...
// Non-hierarchical peer categories — use the dedicated --snm-tag-* palette,
// NEVER the semantic tokens (--snm-brand/warning/success mean primary-action/
// needs-attention/good-money; a price tier is none of those).
        ...
        {matches.length > 0 && onPickExisting && (
          <div className="rounded-xl overflow-hidden" style={{ border: "1px solid color-mix(in srgb, var(--snm-warning) 35%, transparent)" }}>
            ...
            {matches.map((c) => (
              ...
              >
                <div className="h-8 w-8 rounded-full flex items-center justify-center font-bold ios-subhead shrink-0"
