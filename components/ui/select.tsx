...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // data-[size=default]:h-11 (44px) — Apple HIG minimum touch target.
        // Was h-8 (32px); this is the only picker control on forms like the
        // Customer form's Channel select, with no per-call override. "sm"
        // stays compact intentionally for dense desktop contexts.
