-- ============================================================================
-- 0075 — Add product_categories.sort_order to v_skus
-- ============================================================================
...
--
-- Lets client-side catalog sorting (compareSkusForDisplay in
-- lib/queries/products.ts) order by the business-curated category order
-- (Diapers, Liquid Detergent, Powder Detergent, ... ) instead of ignoring
-- category entirely — Inventory/Godowns/Stock Ops were interleaving models
-- from different categories with no consistent order.
-- ============================================================================
